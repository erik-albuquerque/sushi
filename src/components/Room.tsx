...
const Room: React.FC<RoomType> = ({ room }: RoomType) => {
  ...
  return (
    <div
      ...
      className={clsx(
        'flex flex-row items-center gap-1 justify-between py-2 px-3 rounded-xl cursor-pointer w-full select-none',
        `${isSelected ? 'bg-gray-100 ' : 'translate hover:bg-gray-50'}`
      )}
    >
